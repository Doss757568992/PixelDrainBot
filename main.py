...
async def start(bot, update):
    await update.reply_text(
        text=f"Hello {update.from_user.mention}, ɪᴀᴍ ᴀ sɪᴍᴘʟᴇ ᴛᴇʟᴇɢʀᴀᴍ ғɪʟᴇ/ᴠɪᴅᴇᴏ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʟɪɴᴋ ᴀɴᴅ sᴛʀᴇᴀᴍ ʟɪɴᴋ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ.
...
async def media_filter(bot, update):
    ...
    reply_markup = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton(text="Join Updates Channel", url="https://telegram.me/Tamil247Entertainments")
            ]
        ]
    )
